          ...
          <div className="pf-group">
            ...
            <div className="row-2">
              <div className="field">
                ...
                <input className="input" type="number" min={2} max={20} value={suggestedCapacity} onChange={e => setSuggestedCapacity(e.target.value === '' ? 0 : Number(e.target.value))} onBlur={e => setSuggestedCapacity(Math.max(2, Math.min(20, Number(e.target.value) || 2)))} />
              </div>
              <div className="field">
