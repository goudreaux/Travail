...
export type OpsNotifyKind =
  ...
  | 'anchor_cancel_request'       // Anchor requested to cancel their own trip — needs Concierge approval
...
const KIND_META: Record<OpsNotifyKind, { label: string; accent: string; sign: 'in' | 'out' | 'neutral' }> = {
  ...
  anchor_cancel_request:       { label: 'ANCHOR CANCEL REQUEST',    accent: '#d94e2a', sign: 'neutral' },
}
