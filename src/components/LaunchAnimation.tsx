...
// fades away to reveal the page beneath (login when signed out). Doubles as a
// cold-start loading cover. Plays once per session (sessionStorage) so in-app
// reloads — e.g. pull-to-refresh — don't replay it.
//
